...
export const Test8 = () => {
  return (
    <div className="mx-3 md:mx-auto lg:w-[1000px] md:bg-white md:p-4 md:rounded-2xl md:shadow-2xl">
      ...
      <h3 className="text-xl text-center font-bold mt-2">(СЕРЕЖА НАПИШИ КАКОЙ АЛГОРИТМ): </h3>
      <form
        //onSubmit={SendResult}
        className="flex flex-col mx-auto mt-2 md:mt-5 w-[330px] md:w-full overflow-x-scroll md:overflow-hidden"
      >
        <Task5_1 />
        <h3 className="text-xl text-center font-bold mt-5 mb-5">(СЕРЕЖА НАПИШИ СКОЛЬКО КАКОЙ АЛГОРИТМ): </h3>
        <Task5_1 />
