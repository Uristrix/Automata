    ...
    <div className="mx-3 md:mx-auto w-full xl:w-[1000px] md:bg-white md:p-4 md:rounded-2xl md:shadow-2xl">
      ...
      >
        <Task5_1
          ...
          name="first"
          header="Задание 1."
          text={`Выполните умножение ${variant.A1}/${variant.C1} на ${variant.B1}/${variant.C1} в дополнительном коде с корректирующим шагом.`}
        />
        <Task5_1
          inputs={inputs}
          setInputs={setInputs}
          ...
          name="second"
          header="Задание 2."
          text={`Выполните умножение ${variant.A2}/${variant.C2} на ${variant.B2}/${variant.C2} в дополнителььном коде, используя анализ смежных разрядов множителя.`}
        />
        {!disable ? (
