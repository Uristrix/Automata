  ...
  return (
    <div>
      ...
      <table className="table_">
        <caption>
          Контрольная работа № 2 <br className="br4" /> А = {var_A}, В = {var_B}
        </caption>
        <tr>
          <th></th>
          <th>Прямой код</th>
        ...
        <tr>
          <td className="t_1">A</td>
          <td>
            <input type="text" className="test_input" required />
          </td>
          <td>
            <input type="text" className="test_input" required />
          </td>
      ...
      <button className="Button1" onClick={parse}>
